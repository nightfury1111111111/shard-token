...
use shard_token::staking::ExecuteMsg::UpdateConfig;
use shard_token::staking::{
...
fn proper_initialization() {
    ...
    let msg = InstantiateMsg {
        shard_token: "reward0000".to_string(),
    ...
    println!("Setting config has been successfully done.");
    ...
    println!("Store setting has been successfully done.")
}
...
fn test_bond_tokens() {
    ...
    .unwrap();
    let staker_info: StakerInfoResponse = from_binary(&res).unwrap();
    let expected_staker_info = StakerInfoResponse {
        staker: "addr0000".to_string(),
    ...
    .unwrap();
    let state = from_binary::<StateResponse>(&res).unwrap();
    let expected_state = StateResponse {
